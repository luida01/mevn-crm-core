...
## 📋 Features
✅ **Hybrid Inventory System**: Import metadata from MyAnimeList (Jikan) and high-quality covers from MangaDex.
✅ **Volume Management**: Track individual manga volumes with specific covers and stock.
✅ **Smart Search**: Intelligent filtering to find exact series matches and avoid spin-offs.
✅ **Premium UI**: Responsive grid layout, immersive details modal, and dynamic status indicators.
✅ **Stock Control**: Visual "In Stock" / "Out of Stock" tracking with automated button states.
✅ **Interactive Modal**: Rich details view with synopsis, genres, and full-size cover display.
...
📅 **Rental System**: Tracking due dates, late fees, and rental history.
